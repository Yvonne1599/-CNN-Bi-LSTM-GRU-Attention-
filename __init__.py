...
def init_model_by_key(args, tokenizer: Tokenizer):
    ...
    elif key == 'bilstmconvattres_new':
        model = BiLSTMConvAttRes_new(tokenizer.vocab_size, args.embed_dim, args.hidden_dim, args.n_layer, args.embed_drop, args.n_head,args.dim_feedforward)
    else:
